...
// 임시 데이터 (실제 데이터는 API 등으로 관리하게 됩니다)
const MOCK_CAFES = [
  {
    id: 1,
    name: "커피브레이크 서강대점",
...
export default function CafeListPage() {
  ...
  return (
    <div className="min-h-screen  flex justify-center p-4 font-sans">
      <div className="w-full max-w-md bg-[#F2EDE9] flex flex-col gap-6">
        <section>
